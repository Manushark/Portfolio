        ...
        <div class="flex items-center justify-between"
          ...
          <div class="flex items-center gap-2">
            ...
            <button
              ...
              class="theme-btn relative flex items-center justify-center p-2 rounded-xl bg-gray-100/90 dark:bg-white/10 text-gray-700 dark:text-gray-200 border border-gray-200/90 dark:border-white/15 hover:bg-gray-200/90 dark:hover:bg-white/20 hover:border-gray-300 dark:hover:border-white/30 shadow-sm transition-all duration-200">
              @if (themeService.isDarkMode()) {
                <svg class="w-4 h-4 text-amber-400 fill-amber-400/20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
                </svg>
              } @else {
                <svg class="w-4 h-4 text-indigo-500 fill-indigo-500/20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
