      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <span class="text-white font-bold tracking-tight text-base">Manuel de Jesús Rivas</span>
              <p class="text-xs text-gray-400 font-mono">Desarrollador Jr Backend .NET &bull; Angular &bull; QA</p>
            </div>
          </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-gray-400 gap-4">
          ...
          <span>Desarrollado con Angular 19 &bull; Tailwind CSS &bull; Vercel</span>
        </div>
      </div>
    </footer>
  `
