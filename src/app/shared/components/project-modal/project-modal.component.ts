            ...
            <div class="flex items-center gap-2.5 flex-wrap sm:flex-nowrap">
              @if (project.github) {
                <a
                  ...
                  class="action-link inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-white/8 hover:bg-gray-200 dark:hover:bg-white/15 border border-gray-200 dark:border-white/10"
